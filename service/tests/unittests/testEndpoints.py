...
class TestExpectedResults(TestCase):
    ...
    def test_recommendations_200(self):
        '''Test to see if calling the recommender endpoint
        ...
        # before
        mockdata = [
            {'id': '1', 'bibcode': 'ppr1', 'first_author': 'au_ppr1',
             'title': ['ttl_ppr1'], 'reference':['r1', 'r2'],
             'citation':['c1'], 'citation_count':1},
            ...
            {'id': '3', 'bibcode': 'ppr3', 'first_author': 'au_ppr3',
             ...
             'citation':['c2', 'c3'], 'citation_count':2},
        ...
        expected_recommendations = [{u'title': u'ttl_ppr2',
                                     u'bibcode': u'ppr2',
                                     u'author': u'au_ppr2,+'},
                                    {u'title': u'ttl_ppr2',
                                     u'bibcode': u'ppr2',
        ...
        self.assertEqual(
            r.json.get('recommendations'), expected_recommendations)

    @httpretty.activate
    def test_recommendations_500(self):
        '''Test to see if calling the recommender endpoint throws a
           500 when Solr is not available'''
        # To test this method we need both the mock for PostgreSQL
        # and the override for the Solr query (for 'get_article_data').
        # The Solr query needs to return the references and citation counts
        # for the papers found in the co-reads
    ...
    def test_recommendations_no_keywords(self):
        '''Test to see if calling the recommender endpoint works for
           no keywords'''
        # To test this method we need both the mock for PostgreSQL
        # and the override for the Solr query (for 'get_article_data').
        # The Solr query needs to return the references and citation counts
        ...
        mockdata = [
            {'id': '1', 'bibcode': 'ppr1',
             'first_author': 'au_ppr1', 'title': ['ttl_ppr1'],
             'reference':['r1', 'r2'], 'citation':['c1'],
             'citation_count':1},
            {'id': '2', 'bibcode': 'ppr2',
             'first_author': 'au_ppr2', 'title': ['ttl_ppr2'],
             'reference':['r2', 'r3'], 'citation':['c1', 'c2', 'c3'],
             'citation_count':3},
            {'id': '3', 'bibcode': 'ppr3',
             'first_author': 'au_ppr3', 'title': ['ttl_ppr3'],
             'reference':['r2', 'r3'], 'citation':['c2', 'c3'],
             'citation_count':2},
        ...
        # With the mock data the following recommendations should get generated
        expected_recommendations = [{'bibcode': 'ppr3',
                                     'author': u'au_ppr3,+',
                                     'title': u'ttl_ppr3'},
                                    {'bibcode': 'ppr2',
                                     'author': u'au_ppr2,+',
